...
Wcześniejsza, notatnikowa wersja tego kodu różniła się od niniejszego pakietu w dwóch miejscach wpływających na wartości liczbowe. Po pierwsze, iloczyn skalarny w mechanizmie uwagi skalowano pierwiastkiem z n_embd zamiast z wymiaru pojedynczej głowy, niezgodnie ze wzorem Vaswaniego i in., co nadmiernie wygładzało rozkład wag uwagi. Po drugie, obiekty brakujące i dodatkowe zliczano operatorem in, czyli bez uwzględnienia powtórzeń, co zaniżało wyniki dla scen zawierających ten sam obiekt dwukrotnie. Niniejszy pakiet skaluje uwagę zgodnie ze wzorem i zlicza na wielozbiorach, zgodnie z podrozdziałami 3.2 i 3.6 pracy. Wszystkie wyniki przedstawione w pracy policzono wyłącznie tym pakietem.
